...
<html>
<head>
	<title>26 search users and any data from table</title>
</head>
<body>

	<h1 style="text-align: center;">26 search users and any data from table</h1>
	...
	<?php
		...
		$showDataQuery = "SELECT * FROM hasan WHERE fname LIKE '%$searchTerm%'";
